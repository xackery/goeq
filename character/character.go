...
type CharacterData struct {
	...
	Build_data              string    `db:"build_data"`              //	varchar(39)	YES		NULL
	Session                 string    `db:"session"`                 //	varchar(32)	YES		NULL
	Session_timeout         time.Time `db:"session_timeout"`         //	timestamp	NO		CURRENT_TIMESTAMP
}
